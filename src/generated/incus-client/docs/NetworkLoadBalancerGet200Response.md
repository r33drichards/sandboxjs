...
------------ | ------------- | ------------- | -------------
**metadata** | [**NetworkLoadBalancer**](NetworkLoadBalancer.md) |  | [optional] [default to undefined]
...
```typescript
import { NetworkLoadBalancerGet200Response } from 'incus-client';

const instance: NetworkLoadBalancerGet200Response = {
    metadata,
    status,
    status_code,
    type,
