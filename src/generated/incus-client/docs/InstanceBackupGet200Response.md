...
------------ | ------------- | ------------- | -------------
**metadata** | [**InstanceBackup**](InstanceBackup.md) |  | [optional] [default to undefined]
...
```typescript
import { InstanceBackupGet200Response } from 'incus-client';

const instance: InstanceBackupGet200Response = {
    metadata,
    status,
    status_code,
    type,
