...
------------ | ------------- | ------------- | -------------
**metadata** | [**Array&lt;AccessEntry&gt;**](AccessEntry.md) |  | [optional] [default to undefined]
...
```typescript
import { InstanceAccess200Response } from 'incus-client';

const instance: InstanceAccess200Response = {
    metadata,
    status,
    status_code,
    type,
