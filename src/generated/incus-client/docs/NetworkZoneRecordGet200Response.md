...
------------ | ------------- | ------------- | -------------
**metadata** | [**NetworkZoneRecord**](NetworkZoneRecord.md) |  | [optional] [default to undefined]
...
```typescript
import { NetworkZoneRecordGet200Response } from 'incus-client';

const instance: NetworkZoneRecordGet200Response = {
    metadata,
    status,
    status_code,
    type,
