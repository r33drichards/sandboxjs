...
------------ | ------------- | ------------- | -------------
**metadata** | [**ServerUntrusted**](ServerUntrusted.md) |  | [optional] [default to undefined]
...
```typescript
import { ServerGetUntrusted200Response } from 'incus-client';

const instance: ServerGetUntrusted200Response = {
    metadata,
    status,
    status_code,
    type,
