...
------------ | ------------- | ------------- | -------------
**metadata** | [**StorageVolumeBackup**](StorageVolumeBackup.md) |  | [optional] [default to undefined]
...
```typescript
import { StoragePoolVolumesTypeBackupGet200Response } from 'incus-client';

const instance: StoragePoolVolumesTypeBackupGet200Response = {
    metadata,
    status,
    status_code,
    type,
