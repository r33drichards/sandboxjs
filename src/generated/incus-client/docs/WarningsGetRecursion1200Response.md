...
------------ | ------------- | ------------- | -------------
**metadata** | [**Array&lt;Warning&gt;**](Warning.md) | List of warnings | [optional] [default to undefined]
...
```typescript
import { WarningsGetRecursion1200Response } from 'incus-client';

const instance: WarningsGetRecursion1200Response = {
    metadata,
    status,
    status_code,
    type,
