...
**cluster_certificate_path** | **string** | The path to the cluster certificate | [optional] [default to undefined]
...
```typescript
import { InitClusterPreseed } from 'incus-client';

const instance: InitClusterPreseed = {
    cluster_address,
    cluster_certificate,
