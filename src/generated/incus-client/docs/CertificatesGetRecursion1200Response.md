...
------------ | ------------- | ------------- | -------------
**metadata** | [**Array&lt;Certificate&gt;**](Certificate.md) | List of certificates | [optional] [default to undefined]
...
```typescript
import { CertificatesGetRecursion1200Response } from 'incus-client';

const instance: CertificatesGetRecursion1200Response = {
    metadata,
    status,
    status_code,
    type,
