...
------------ | ------------- | ------------- | -------------
**metadata** | [**NetworkZone**](NetworkZone.md) |  | [optional] [default to undefined]
...
```typescript
import { NetworkZoneGet200Response } from 'incus-client';

const instance: NetworkZoneGet200Response = {
    metadata,
    status,
    status_code,
    type,
