...
------------ | ------------- | ------------- | -------------
**metadata** | [**StorageVolumeState**](StorageVolumeState.md) |  | [optional] [default to undefined]
...
```typescript
import { StoragePoolVolumeTypeStateGet200Response } from 'incus-client';

const instance: StoragePoolVolumeTypeStateGet200Response = {
    metadata,
    status,
    status_code,
    type,
