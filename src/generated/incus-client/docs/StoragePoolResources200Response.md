...
------------ | ------------- | ------------- | -------------
**metadata** | [**ResourcesStoragePool**](ResourcesStoragePool.md) |  | [optional] [default to undefined]
...
```typescript
import { StoragePoolResources200Response } from 'incus-client';

const instance: StoragePoolResources200Response = {
    metadata,
    status,
    status_code,
    type,
