...
------------ | ------------- | ------------- | -------------
**metadata** | [**NetworkState**](NetworkState.md) |  | [optional] [default to undefined]
...
```typescript
import { NetworksStateGet200Response } from 'incus-client';

const instance: NetworksStateGet200Response = {
    metadata,
    status,
    status_code,
    type,
