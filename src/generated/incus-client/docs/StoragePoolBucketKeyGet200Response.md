...
------------ | ------------- | ------------- | -------------
**metadata** | [**StorageBucketKey**](StorageBucketKey.md) |  | [optional] [default to undefined]
...
```typescript
import { StoragePoolBucketKeyGet200Response } from 'incus-client';

const instance: StoragePoolBucketKeyGet200Response = {
    metadata,
    status,
    status_code,
    type,
