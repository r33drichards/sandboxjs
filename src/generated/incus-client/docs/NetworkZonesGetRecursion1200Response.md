...
------------ | ------------- | ------------- | -------------
**metadata** | [**Array&lt;NetworkZone&gt;**](NetworkZone.md) | List of network zones | [optional] [default to undefined]
...
```typescript
import { NetworkZonesGetRecursion1200Response } from 'incus-client';

const instance: NetworkZonesGetRecursion1200Response = {
    metadata,
    status,
    status_code,
    type,
