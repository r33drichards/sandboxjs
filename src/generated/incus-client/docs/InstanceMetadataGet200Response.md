...
------------ | ------------- | ------------- | -------------
**metadata** | [**ImageMetadata**](ImageMetadata.md) |  | [optional] [default to undefined]
...
```typescript
import { InstanceMetadataGet200Response } from 'incus-client';

const instance: InstanceMetadataGet200Response = {
    metadata,
    status,
    status_code,
    type,
