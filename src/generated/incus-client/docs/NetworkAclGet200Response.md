...
------------ | ------------- | ------------- | -------------
**metadata** | [**NetworkACL**](NetworkACL.md) |  | [optional] [default to undefined]
...
```typescript
import { NetworkAclGet200Response } from 'incus-client';

const instance: NetworkAclGet200Response = {
    metadata,
    status,
    status_code,
    type,
