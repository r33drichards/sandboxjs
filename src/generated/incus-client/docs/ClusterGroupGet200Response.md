...
------------ | ------------- | ------------- | -------------
**metadata** | [**ClusterGroup**](ClusterGroup.md) |  | [optional] [default to undefined]
...
```typescript
import { ClusterGroupGet200Response } from 'incus-client';

const instance: ClusterGroupGet200Response = {
    metadata,
    status,
    status_code,
    type,
