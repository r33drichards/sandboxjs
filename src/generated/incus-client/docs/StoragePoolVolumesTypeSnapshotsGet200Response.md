...
------------ | ------------- | ------------- | -------------
**metadata** | **Array&lt;string&gt;** | List of endpoints | [optional] [default to undefined]
...
```typescript
import { StoragePoolVolumesTypeSnapshotsGet200Response } from 'incus-client';

const instance: StoragePoolVolumesTypeSnapshotsGet200Response = {
    metadata,
    status,
    status_code,
    type,
