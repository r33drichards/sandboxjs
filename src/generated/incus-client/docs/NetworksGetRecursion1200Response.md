...
------------ | ------------- | ------------- | -------------
**metadata** | [**Array&lt;Network&gt;**](Network.md) | List of networks | [optional] [default to undefined]
...
```typescript
import { NetworksGetRecursion1200Response } from 'incus-client';

const instance: NetworksGetRecursion1200Response = {
    metadata,
    status,
    status_code,
    type,
