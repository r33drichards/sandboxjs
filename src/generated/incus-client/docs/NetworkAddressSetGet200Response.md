...
------------ | ------------- | ------------- | -------------
**metadata** | [**NetworkAddressSet**](NetworkAddressSet.md) |  | [optional] [default to undefined]
...
```typescript
import { NetworkAddressSetGet200Response } from 'incus-client';

const instance: NetworkAddressSetGet200Response = {
    metadata,
    status,
    status_code,
    type,
