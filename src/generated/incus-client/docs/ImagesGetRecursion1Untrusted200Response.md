...
------------ | ------------- | ------------- | -------------
**metadata** | [**Array&lt;Image&gt;**](Image.md) | List of images | [optional] [default to undefined]
...
```typescript
import { ImagesGetRecursion1Untrusted200Response } from 'incus-client';

const instance: ImagesGetRecursion1Untrusted200Response = {
    metadata,
    status,
    status_code,
    type,
