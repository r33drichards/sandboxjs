...
------------ | ------------- | ------------- | -------------
**metadata** | [**ClusterMemberState**](ClusterMemberState.md) |  | [optional] [default to undefined]
...
```typescript
import { ClusterMemberStateGet200Response } from 'incus-client';

const instance: ClusterMemberStateGet200Response = {
    metadata,
    status,
    status_code,
    type,
