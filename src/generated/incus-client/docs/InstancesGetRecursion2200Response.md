...
------------ | ------------- | ------------- | -------------
**metadata** | [**Array&lt;InstanceFull&gt;**](InstanceFull.md) | List of instances | [optional] [default to undefined]
...
```typescript
import { InstancesGetRecursion2200Response } from 'incus-client';

const instance: InstancesGetRecursion2200Response = {
    metadata,
    status,
    status_code,
    type,
