...
------------ | ------------- | ------------- | -------------
**metadata** | [**Array&lt;NetworkLease&gt;**](NetworkLease.md) | List of DHCP leases | [optional] [default to undefined]
...
```typescript
import { NetworksLeasesGet200Response } from 'incus-client';

const instance: NetworksLeasesGet200Response = {
    metadata,
    status,
    status_code,
    type,
