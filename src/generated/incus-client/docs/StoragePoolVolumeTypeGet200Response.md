...
------------ | ------------- | ------------- | -------------
**metadata** | [**StorageVolume**](StorageVolume.md) |  | [optional] [default to undefined]
...
```typescript
import { StoragePoolVolumeTypeGet200Response } from 'incus-client';

const instance: StoragePoolVolumeTypeGet200Response = {
    metadata,
    status,
    status_code,
    type,
