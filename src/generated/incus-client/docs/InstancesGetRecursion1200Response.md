...
------------ | ------------- | ------------- | -------------
**metadata** | [**Array&lt;Instance&gt;**](Instance.md) | List of instances | [optional] [default to undefined]
...
```typescript
import { InstancesGetRecursion1200Response } from 'incus-client';

const instance: InstancesGetRecursion1200Response = {
    metadata,
    status,
    status_code,
    type,
