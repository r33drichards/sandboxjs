...
------------ | ------------- | ------------- | -------------
**metadata** | [**InstanceState**](InstanceState.md) |  | [optional] [default to undefined]
...
```typescript
import { InstanceStateGet200Response } from 'incus-client';

const instance: InstanceStateGet200Response = {
    metadata,
    status,
    status_code,
    type,
