...
------------ | ------------- | ------------- | -------------
**metadata** | [**NetworkForward**](NetworkForward.md) |  | [optional] [default to undefined]
...
```typescript
import { NetworkForwardGet200Response } from 'incus-client';

const instance: NetworkForwardGet200Response = {
    metadata,
    status,
    status_code,
    type,
