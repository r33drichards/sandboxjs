...
------------ | ------------- | ------------- | -------------
**metadata** | **{ [key: string]: Array&lt;string&gt;; }** | JSON object of operation types to operation URLs | [optional] [default to undefined]
...
```typescript
import { OperationsGet200Response } from 'incus-client';

const instance: OperationsGet200Response = {
    metadata,
    status,
    status_code,
    type,
