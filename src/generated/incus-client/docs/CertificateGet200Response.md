...
------------ | ------------- | ------------- | -------------
**metadata** | [**Certificate**](Certificate.md) |  | [optional] [default to undefined]
...
```typescript
import { CertificateGet200Response } from 'incus-client';

const instance: CertificateGet200Response = {
    metadata,
    status,
    status_code,
    type,
