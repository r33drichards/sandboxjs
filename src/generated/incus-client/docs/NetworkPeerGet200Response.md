...
------------ | ------------- | ------------- | -------------
**metadata** | [**NetworkPeer**](NetworkPeer.md) |  | [optional] [default to undefined]
...
```typescript
import { NetworkPeerGet200Response } from 'incus-client';

const instance: NetworkPeerGet200Response = {
    metadata,
    status,
    status_code,
    type,
