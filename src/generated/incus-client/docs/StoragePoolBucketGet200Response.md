...
------------ | ------------- | ------------- | -------------
**metadata** | [**StorageBucket**](StorageBucket.md) |  | [optional] [default to undefined]
...
```typescript
import { StoragePoolBucketGet200Response } from 'incus-client';

const instance: StoragePoolBucketGet200Response = {
    metadata,
    status,
    status_code,
    type,
